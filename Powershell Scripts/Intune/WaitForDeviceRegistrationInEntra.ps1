...
If(-not(Test-Path -Path "$($env:ProgramData)\CXN\Scripts\WaitForDeviceRegistrationInEntra"))
    {
    New-Item -itemtype "directory" -path "$($env:ProgramData)\CXN\Scripts\WaitForDeviceRegistrationInEntra"
    Set-Content -Path "$($env:ProgramData)\CXN\Scripts\WaitForDeviceRegistrationInEntra\WaitForDeviceRegistrationInEntra.ps1.tag" -Value "Installed"
    }

#Start logging
Start-Transcript "$($env:ProgramData)\CXN\Scripts\WaitForDeviceRegistrationInEntra.log"
