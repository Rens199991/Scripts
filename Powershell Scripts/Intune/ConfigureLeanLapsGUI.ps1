#leanLAPS GUI, provided AS IS as companion to the leanLAPS script --> https://www.lieben.nu/liebensraum/2021/06/lightweight-laps-solution-for-intune-mde/
#See ConfigureLeanLapsIntuneDetection


#To get this ID, go to graph explorer https://aka.ms/ge and use this query https://graph.microsoft.com/beta/deviceManagement/deviceHealthScripts to get all remediation scripts in your tenant and select the Windows-DRConfigureLeanLapsIntune GUI script id
$remediationScriptID = "abfe82d2-0ddd-48a5-926f-3b54f5d7f8de" 

$ErrorActionPreference = "Stop"

#if you supply a private key, this will be used to decrypt the password (assuming it was encrypting using your public key, as configured in leanLAPS.ps1
$privateKey = "" 

#password change times are in UTC, if you wish to show whatever timezone is detected on the local device, set this to $True
$showLocalDateTime = $True
