...
If(-not(Test-Path -Path "$($env:ProgramData)\CXN\Scripts\RemoveBloatware"))
	{
    New-Item -itemtype "directory" -path "$($env:ProgramData)\CXN\Scripts\RemoveBloatware"
    Set-Content -Path "$($env:ProgramData)\CXN\Scripts\RemoveBloatware\RemoveBloatware.ps1.tag" -Value "Installed"
    }
